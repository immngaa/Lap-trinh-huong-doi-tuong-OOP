...
namespace Nhom03
{
    public partial class ChartFormPhanTichXuHuong : Form
    {
        ...
        private void ShowChart()
        {
            ...
            {
                string thuongHieu = row["Tên thương hiệu"].ToString();  // Tên thương hiệu
                string nhomKH = row["TenNhomKH"].ToString();  // Nhóm khách hàng (Thân thiết hoặc Tiềm năng)
                ...
                {
                    thuongHieuDict[thuongHieu] = (thuongHieuDict[thuongHieu].khachHangThanThiet + soLuong, thuongHieuDict[thuongHieu].khachHangTiemNang);
                }
                else if (nhomKH == "Khách hàng tiềm năng")
                {
                    thuongHieuDict[thuongHieu] = (thuongHieuDict[thuongHieu].khachHangThanThiet, thuongHieuDict[thuongHieu].khachHangTiemNang + soLuong);
                }
            }
